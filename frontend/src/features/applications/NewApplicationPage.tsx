    ...
    <div className="form-layout">
      <section className="panel form-card">
        ...
        <form onSubmit={event => void form.handleSubmit(values => mutation.mutate(values))(event)} noValidate>
          ...
          <div className="form-info"><ShieldCheck size={20} /><span><strong>Bezpečné odeslání žádosti</strong><small>Při přerušení spojení systém zabrání nechtěnému založení duplicitní žádosti.</small></span></div>
